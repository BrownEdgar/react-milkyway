    ...
    return (
        <div className="App">
            ...
            <div className="table">
               <table>
                  <tr>
                    <th>FirstName:{JSON.stringify(values)}</th>
                    <th>LastName:{JSON.stringify(values.lastname)}</th>
                    <th>EmailAddress:{JSON.stringify(values.email)}</th>
                    <th>WebsiteName:{JSON.stringify(values.webname)}</th>
                    <th>YourMessage:{JSON.stringify(values.message)}</th>
                  </tr>
                </table>
            </div>
